...
| String
| Specifies if link:https://docs.microsoft.com/azure/virtual-network/ddos-protection-overview[Azure DDoS Protection] is enabled on the workload virtual network automatically on creation.
