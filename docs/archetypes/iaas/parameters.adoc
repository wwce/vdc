...
These parameters are specific to the link:../archetypes/ntier-iaas/parameters/archetype.test.json[IaaS example] workload deployment. They are in the `workload` section.
