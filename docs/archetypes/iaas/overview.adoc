...
.Docker
[source,bash]
python vdc.py create shared-services -path archetypes/iaas/archetype.json -m sqlserver-alwayson

.Linux/OSX
[source,bash]
python3 vdc.py create shared-services -path archetypes/iaas/archetype.json -m sqlserver-alwayson

.Windows
[source,cmd]
py vdc.py create shared-services -path archetypes/iaas/archetype.json -m sqlserver-alwayson
...
.Docker
[source,bash]
python vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-web-lb

.Linux/OSX
[source,bash]
python3 vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-web-lb

.Windows
[source,cmd]
py vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-web-lb
...
.Docker
[source,bash]
python vdc.py create shared-services -path archetypes/iaas/archetype.json -m app-gateway

.Linux/OSX
[source,bash]
python3 vdc.py create shared-services -path archetypes/iaas/archetype.json -m app-gateway

.Windows
[source,cmd]
py vdc.py create shared-services -path archetypes/iaas/archetype.json -m app-gateway
...
.Docker
[source,bash]
python vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-biz-lb

.Linux/OSX
[source,bash]
python3 vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-biz-lb

.Windows
[source,cmd]
py vdc.py create shared-services -path archetypes/iaas/archetype.json -m vmapp-biz-lb
